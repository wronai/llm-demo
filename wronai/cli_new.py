...
from wronai.models.huggingface import HFModelConfig, HFModelManager
from wronai.models.ollama import OllamaConfig, OllamaModelManager
...
def convert_to_ollama(
    hf_model_path: str, output_dir: str, quantization: str, model_name: str
):
    ...
    with Progress(
        ...
        try:
            ...
            success_console(
                f"Model converted and available as '{model_name}'. Run with: ollama run {model_name}"
            )
